...
par(mfrow=c(2,2))
plot(data2, gapower,ylab='Global Active Power', xlab='', type='l')
plot(data2,subdata1$Voltage,xlab='datetime',ylab='Voltage',type='l')
...
plot(data2,subdata1$Global_reactive_power,xlab='datetime',ylab='Global_reactive_power',type='l')
dev.off()
